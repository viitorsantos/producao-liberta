                    ...
                    <div class="col-md-10 corpo">
                        <div class="page-header">
                            ...
                            <div class="col-md-1 link_tela">
                                <a href="cadastro_receitas.php?paciente=<?php echo $paciente_id?>&funcionario=<?php echo $_funcionario_id?>" class="btn btn-success btn-sm"><i class="fa fa-list-alt"></i>Novo</a>      
                            </div>
                            <div class="col-md-1 link_tela">
                        ...
                        <div class="conteudo">
                            <div class="table-responsive">
                                <table class="table table-striped">  
                                    ...
                                    <tbody>
                                         <?php
                                            $sql = "SELECT receita, observacao, cadastro from tbl_receita where empresa_id = ".EMPRESA." and paciente_id = $paciente_id";
                                            $res = pg_query($con, $sql);
                                            for($i=0; $i<pg_num_rows($res); $i++){
                                                $receita_id         = pg_fetch_result($res, $i, 'receita');
                                                ...
                                                echo "<tr>";
                                                    ...
                                                    echo "<td>$cadastro</td>"; 
                                                    echo "<td class='col-md-1'><a href='./cadastro_receitas.php?receita=$receita_id&paciente=$paciente_id&funcionario=$_funcionario_id' title='Editar'><i class='fa fa-pencil-square-o'></i></a></td>";
                                                    echo "<td class='col-md-1'><a href='./imprimir_orientacoes.php?receita=$receita_id&paciente=$paciente_id&funcionario=$_funcionario_id' title='Imprimir'><i class='fa fa-print'></i></a></td>";
                                                echo "</tr>";
