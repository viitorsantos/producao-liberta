<?php
    ...
    if(isset($_POST["btnacao"])){     
		...
		$rg 		= str_replace($caracter,"",$_POST['rg']);
        ...
        if(empty($erro)){
            if($funcionario_id == 0){
                $sql = "INSERT INTO tbl_funcionario (nome, cpf, rg, idade, sexo, estado_civil, rua_av, numero, complemento, cep, cidade_id, bairro, profissao, email, ddd_tel, telefone, ddd_cel, celular, data_nasc, crm, grupo_usuario_id, empresa_id)  
                VALUES ('$nome', '$cpf', '$rg', '$idade', '$sexo', '$estado_civil', '$rua_av', '$numero', '$complemento', '$cep', '$cidade_id', '$bairro', '$profissao', '$email', '$ddd_tel', '$telefone', '$ddd_cel', '$celular', '".fnc_formata_data($_POST["data_nasc"])."', '$crm', $grupo_usuario_id, $empresa_id)";
            }else{
                ...
                cep = '$cep', cidade_id = $cidade_id, bairro = '$bairro', profissao = '$profissao',  email = '$email', ddd_tel = '$ddd_tel', telefone = '$telefone', ddd_cel = '$ddd_cel', celular = '$celular', data_nasc = '".fnc_formata_data($_POST["data_nasc"])."', crm = '$crm', empresa_id = $empresa_id
                    ...
                    <div class="col-md-10 corpo" >
                        <div class="page-header">
                            ...
                            <div class="col-md-2 link_tela">
                                <a href="funcionario_listar.php" class="btn btn-info btn-sm"><i class="fa fa-list-alt"></i>Listar</a>       
                            </div>
                        </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label  for="exampleInputEmail1">Data de Nascimento*</label>
																		  <input type="text" name="data_nasc" value="<?php echo $data_nasc ?>" maxlength="10"  class="form-control"  id="data_nasc" placeholder="Data de Nascimento">
                                                    </div>
                                                </div>
                                                <div class="col-md-1">
                                                    <div class="form-group">
											...
											<div class="row">
												<div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="bairro" id="bairro" value="<?php echo $bairro ?>" maxlength="30" class="form-control" placeholder="Bairro">
                                                    </div>
                                                 </div>
												 <div class="col-md-4">
													<div class="form-group">
                                            ...
                                            <div class='row'>
												...
												<div class="col-md-3">
													<div class="form-group">
														...
														<?php 
														$sql_cidade = "SELECT grupo_usuario, descricao FROM tbl_grupo_usuario";
														 $res_cidade = pg_query($con, $sql_cidade);
														 for($i =0; $i<pg_num_rows($res_cidade); $i++){
