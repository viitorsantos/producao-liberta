...
<body>
	<div id="interface">
		...
		<div class="botao">
					<input class="button btn_1" href="imprimir_orientacoes.php?paciente=<?php echo $paciente_id?>"  value="Imprimir" onclick="imprime()">
					<a href="cadastro_receitas.php?paciente=<?php echo $paciente_id?>&receita=<?php echo $receita_id?>&funcionario=<?php echo $_funcionario_id?>" class="btn_2">Voltar</a>
                </div>
