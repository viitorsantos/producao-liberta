                    ...
                    <div class="col-md-10 corpo">
                        <div class="page-header">
                            ...
                            <div class="col-md-1 link_tela">
                                <a href="encaminhamento.php?paciente=<?php echo $paciente_id?>" class="btn btn-success btn-sm"><i class="fa fa-list-alt"></i>Novo</a>      
                            </div>
                            <div class="col-md-1 link_tela">
                        ...
                        <div class="conteudo">
                            <div class="table-responsive">
                                <table class="table table-striped">  
                                    ...
                                    <tbody>
                                         <?php
                                            $sql = "SELECT encaminhamento, profissional_id, observacao from tbl_encaminhamento where paciente_id = $paciente_id";
                                            $res = pg_query($con, $sql);
                                            for($i=0; $i<pg_num_rows($res); $i++){
                                                $encaminhamento_id   = pg_fetch_result($res, $i, 'encaminhamento');
                                                $observacao          = pg_fetch_result($res, $i, 'observacao');  
                                                $profissional_id     = pg_fetch_result($res, $i, 'profissional_id');  												
                                               
                                                echo "<tr>";
                                                    echo "<td class='col-md-1'>".($i+1)."</td>";
                                                    echo "<td>$observacao</td>"; 
                                                    echo "<td class='col-md-1'><a href='./encaminhamento.php?encaminhamento=$encaminhamento_id&paciente=$paciente_id' title='Editar'><i class='fa fa-pencil-square-o'></i></a></td>";
                                                    echo "<td class='col-md-1'><a href='./imprimir_encaminhamento.php?encaminhamento=$encaminhamento_id&paciente=$paciente_id' title='Imprimir'><i class='fa fa-print'></i></a></td>";
                                                echo "</tr>";
                                            }
                                         ?>
                                    </tbody>
