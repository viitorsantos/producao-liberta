<?php
    ...
    if(isset($_POST["btnacao"])){
        ...
        $medicamento_id        =   fncTrataDados($_POST["medicamento"]);
        ...
        if(empty($erro)){
            if($medicamento_id == 0){
                $sql = "INSERT INTO tbl_medicamento (descricao)  
                VALUES ('$descricao')";
            }else{
                $sql = "UPDATE tbl_medicamento SET descricao = '$descricao'
    ...
    if(isset($_GET['medicamento'])){
        $medicamento_id = (int)$_GET['medicamento'];

        $sql_medicamento = "select descricao from tbl_medicamento where medicamento = $medicamento_id ";
        $res_medicamento = pg_query($con, $sql_medicamento);
            $descricao          = pg_fetch_result($res_medicamento, 0, 'descricao');
                   ...
                   <?php include RAIZ."include/cabecalho.php" ?>
                    ...
                    <div class="col-md-10 corpo" >
                        <div class="page-header">
                            <div class=" col-md-10 titulo_tela" >Medicamento</div>
							 <div class="col-md-2 link_tela">
								<a href="medicamentos_listar.php" class="btn btn-success btn-sm"><i class="fa fa-list-alt"></i>Lista</a>
							 </div>
                        </div>
                            ...
                            <div class="col-md-12" id="home">
                                ...
                                <div class="row">
                                    <div class="col-md-12 botao">
                                        ...
                                        <input type="hidden" name="medicamento" value="<?php echo $medicamento_id ?>">
                                    </div>
                                </div>
                               </form>
