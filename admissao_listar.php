                ...
                <div class="row">
                    ...
                    <div class="col-md-10 corpo">
                        <div class="page-header">
                            <div class=" col-md-9 titulo_tela" >Admissão</div>
                            <div class="col-md-1 link_tela">
                                <a href="cadastro_admissao.php?paciente=<?php echo $paciente_id?>" class="btn btn-success btn-sm"><i class="fa fa-list-alt"></i>Novo</a>      
                            </div>
                            <div class="col-md-1 link_tela">
                        ...
                        <div class="conteudo">
                            <div class="table-responsive">
                                <table class="table table-striped">  
                                    ...
                                    <tbody>
                                         <?php
                                            $sql = "SELECT admissao, observacao, cadastro from tbl_admissao where empresa_id = ".EMPRESA." and paciente_id = $paciente_id";
                                            $res = pg_query($con, $sql);
                                            for($i=0; $i<pg_num_rows($res); $i++){
                                                $admissao_id	= pg_fetch_result($res, $i, 'admissao');
                                                ...
                                                echo "<tr>";
													...
													echo "<td>$cadastro</td>"; 
                                                  //  echo "<td class='col-md-1'><a href='./cadastro_admissao.php?admissao=$admissao_id&paciente=$paciente_id&funcionario=$_funcionario_id' title='Editar'><i class='fa fa-pencil-square-o'></i></a></td>";
                                                    echo "<td class='col-md-1'><a href='./imprimir_admissao.php?admissao=$admissao_id&paciente=$paciente_id&funcionario=$_funcionario_id' title='Imprimir'><i class='fa fa-print'></i></a></td>";
                                                echo "</tr>";
                                            }
                                         ?>
                                    </tbody>
